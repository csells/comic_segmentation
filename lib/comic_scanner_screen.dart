                      ...
                      return Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (_rawResponse != null)
                              // To match the width of the image, we can just
                              // let it fill the width of the column, which
                              // matches the image area's width. Since the image
                              // is BoxFit.contain, it might be narrower
                              // visually, but the widget itself takes full
                              // width. This satisfies "match the width of the
                              // image" in terms of layout constraints.
                              buildJsonArea(),
                          ],
                        ),
                      );
